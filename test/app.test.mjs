...
test("static app includes every primary control and asset reference", async () => {
  ...
  assert.match(script, /const HILL_MAX_SPIN = 0\.07/);
  ...
  assert.match(script, /targetCtx\.lineWidth = 3/);
  ...
  assert.match(script, /\{ x: 38400, y: 252 \}/);
