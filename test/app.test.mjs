...
test("static app includes every primary control and asset reference", async () => {
  ...
  assert.match(script, /const CHASSIS_WIDTH = 112/);
  assert.match(script, /const CHASSIS_HEIGHT = 34/);
  assert.match(script, /const WHEEL_BASE = 96/);
  assert.match(script, /const WHEEL_RADIUS = 16/);
